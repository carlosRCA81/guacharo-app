...
async function cargarDatos() {
    ...
    if (data) {
        // Lógica de Historial (Muestra los últimos 5)
        ...
        // Contador del 75 (Guácharo)
        const countDisplay = document.getElementById('count-75');
        if (countDisplay) {
            const c75 = data.filter(i => i.numero === "75").length;
            countDisplay.innerText = c75 + " veces";
        }
    }
}

// Iniciar pidiendo la clave
