...
// FUNCION DE ARRANQUE (Llamada desde security.js)
...
function estudiarAnimalEspecifico() {
    ...
    res.innerHTML = `<div style="padding:10px; background:#1e293b; border-radius:8px;">
...
async function guardarDato() {
    ...
    await _supabase.from('historial_resultados').insert([
        { fecha: f, hora: h, numero: n, animal: DATA_ANIMALES[n].a }
    ]);
